      ...
      <header className="flex flex-wrap items-baseline justify-between gap-2">
        <h3 className="text-[13px] font-semibold text-ink">
          ...
          <button
            ...
            className="ml-2 align-middle text-[12px] font-normal text-ink-faint underline underline-offset-2 hover:text-brand"
          >
            Rename
          </button>
        </h3>
        <span className="tabular text-[12px] text-ink-muted">{when}</span>
      </header>
    );
  }

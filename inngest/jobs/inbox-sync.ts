...
} from '@/lib/jobs/inbox/sync-account';
import {
...
/**
 * Backfill page size. Larger pages plus parallel ingest finish the 50-second
 * pump budget in fewer hops; smaller than the commerce app's because every
 * actionable message here costs a model call.
 */
const BATCH_SIZE = 20;

...
function sessionTurn(
  ...
  return (
    ...
    "'claude', '<your answer>');\n\n" +
    'Answer it and nothing else. Do not answer a decision, do not change the status, the ' +
    'detail or the done-when of any plan row, do not shape an idea, do not close or dismiss ' +
    'a raise, and do not commit anything. The person asked what something means, not for it ' +
    'to be settled or built.'
  );
}
